...
const DealCardControls = ({ isArchived, handleArchiveClick, onEditClick }) => {
  ...
  return (
    <div className='p-6 flex justify-between w-full max-w-3xl bg-white rounded-lg mt-3'>
      ...
      <div className='flex gap-3 items-center'>
        <button onClick={onEditClick} className='flex items-center gap-2 text-slate-800 hover:text-orange-600 transition-colors duration-300'> <BsPencil size={"1.2em"} /> Edit  </button>
